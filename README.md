# 简介
欢迎来到notjokker的第一个个人博客。（2026.07.04注：已经初步施工好了注册、登录、点赞、评论（暂时不支持图片评论qwq）、写文章、玩2048这几个功能。下面目标里的subscribe和ai agent由于才疏学浅，暂时还没有做到，请各位见谅。）

首先这个博客一定要完成最基本的功能（比如内容展示，交互界面什么的），以及其他一些能代表作者自己的东西（包括但不限于作者分享一些自己写的文章，以及复刻作者小时候最爱玩的小游戏2048，怀旧感拉满了）。

当然了，作者才疏学浅，ddl其实也挺紧张（脑子里突然涌进这么多新鲜的事物虽然有ai助我一臂之力但真正实践起来才发现ai还是取代不了人类。。。），所以走过路过的朋友请畅所欲言，也可以试试在上面注册、点赞、评论。
你们的建议和参与是我最大的行动动力。

作者在github上的commit很少，这是因为docker在翻墙运行的速度不如我挂镜像（似乎），所以我一般先在本地调试一些最基本的功能，直到最后才把它带到github上和大家见面。
